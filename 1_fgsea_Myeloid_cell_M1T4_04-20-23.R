...
fwrite(fgseaResTidy, file="Myeloid_M1T4_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_2, file="Myeloid_M1T4_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_5, file="Myeloid_M1T4_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
