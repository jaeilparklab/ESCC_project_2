...
fwrite(fgseaResTidy, file="Bcell_B2T3_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_2, file="Bcell_B2T3_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_2 = read.csv('Bcell_B2T3_GSEA_results_REACTOME.csv', sep=",")
...
fwrite(fgseaResTidy_5, file="Bcell_B2T3_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_5 = read.csv("Bcell_B2T3_GSEA_results_GOBP.csv", sep = ",")
