...
M3T4 <- readRDS('M3T4.celltype_detail_after_cellchat.rds')
...
object.list_12 <- list(M2T3 = M2T3, M3T4 = M3T4)
cellchat_12 <- mergeCellChat(object.list_12, add.names = names(object.list_12), cell.prefix = TRUE)
cellchat_12
saveRDS(cellchat_12, 'cellchat.M2T3_M3T4_merged.rds')
...
# red: increased in M3T4, blue: decreased in M3T4
...
net.up <- subsetCommunication(cellchat_12_1, net = net, datasets = "M3T4",ligand.logFC = 0.2, receptor.logFC = NULL)
