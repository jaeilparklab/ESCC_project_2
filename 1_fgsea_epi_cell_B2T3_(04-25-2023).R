...
fwrite(fgseaResTidy, file="Epi_cell_B2T3_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_2, file="Epi_cell_B2T3_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_2 = read.csv('Epi_cell_B2T3_GSEA_results_REACTOME.csv', sep=",")
...
fwrite(fgseaResTidy_5, file="Epi_cell_B2T3_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_5 = read.csv("Epi_cell_B2T3_GSEA_results_GOBP.csv", sep = ",")
