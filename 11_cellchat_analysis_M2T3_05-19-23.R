...
setwd('/Users/kko1/Library/CloudStorage/OneDrive-InsideMDAnderson/13. KyungPil Ko/Experiment_results/scRNA-seq/ESCC_69_patients_integration/_Immune_cell_T4_M4_04-12-23_modified')
...
#    [1] "MIF"      "MHC-I"    "APP"      "CD99"     "CD22"     "CD45"     "GALECTIN" "THBS"     "COLLAGEN" "CLEC"     "ANNEXIN"  "MK"       "LAMININ"  "CXCL"     "ADGRE5"   "BAFF"     "CD86"    
#[18] "NECTIN"   "TIGIT"    "ITGB2"    "LCK"      "ICAM"     "MPZ"      "APRIL"    "ALCAM"    "CD6"      "SELPLG"   "JAM"      "CD39"             
