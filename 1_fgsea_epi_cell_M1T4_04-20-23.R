...
fwrite(fgseaResTidy, file="epi_M1T4_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_2, file="epi_M1T4_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
...
fwrite(fgseaResTidy_5, file="epi_M1T4_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
